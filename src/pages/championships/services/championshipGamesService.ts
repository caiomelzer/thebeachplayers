...
export const fetchChampionshipGames = async (championshipId: string, forceRefresh = false) => {
  ...
  try {
    ...
    const response = await apiClient.get(`/api/championship/${championshipId}/games`);
